...
For OpenShift Container Platform bare metal or VMware vSphere with GPU Passthrough no particular actions are needed. The default cluster policy works. For more information on creating a cluster policy see, :ref:`Create the cluster policy for the NVIDIA GPU Operator<create-cluster-policy-1.11.0>`.
...
Follow the guidance in :ref:`install-nfd-1.11.0` to install the Node Feature Discovery Operator.


Install the NVIDIA GPU Operator
===============================

Follow the guidance in :ref:`install-nvidiagpu-1.11.0` to install the NVIDIA GPU Operator.
