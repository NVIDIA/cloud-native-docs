...
.. _operator-install-guide-1.11.0:
...
follow the :ref:`user guide <openshift-introduction-1.11.0>`.
...
follow the :ref:`NVIDIA AI Enterprise document <install-gpu-operator-1.11.0-nvaie>`.
