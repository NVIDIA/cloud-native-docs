...
.. _operator-platform-support-22.9.2:
...
.. tabs::
  ...
  .. tab:: Data Center A, H and L-series Products
    ...
    .. note::
      ...
      * The GPU Operator supports DGX A100 with DGX OS 5.1+ and Red Hat OpenShift using Red Hat Core OS. For installation instructions, see :ref:`here <preinstalled-drivers-and-toolkit-22.9.2>` for DGX OS 5.1+ and :ref:`here <openshift-introduction-22.9.2>` for Red Hat OpenShift.
...
.. _gpu-operator-arm-platforms-22.9.2:
...
For more information on GPUDirect RDMA refer to :ref:`this document <operator-rdma-22.9.2>`.
