...
.. _operator-install-guide-22.9.2:
...
follow the :ref:`user guide <openshift-introduction-22.9.2>`.
...
follow the :ref:`NVIDIA AI Enterprise document <install-gpu-operator-22.9.2-nvaie>`.
