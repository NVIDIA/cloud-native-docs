...
.. _operator-platform-support-22.9.1:
...
.. tabs::
  ...
  .. tab:: Datacenter A, H and L-series Products
    ...
    .. note::
      ...
      * The GPU Operator supports DGX A100 with DGX OS 5.1+ and Red Hat OpenShift using Red Hat Core OS. For installation instructions, see :ref:`here <preinstalled-drivers-and-toolkit-22.9.1>` for DGX OS 5.1+ and :ref:`here <openshift-introduction-22.9.1>` for Red Hat OpenShift.
...
.. _gpu-operator-arm-platforms-22.9.1:
...
.. tabs::
  ...
  .. tab:: Bare Metal / Virtual Machines with GPU Passthrough 
    ...
    +-----------------------------------------+------------------------------+-------------------+-----------------------------+-------------------------------+-------------------------------------+
    | Ubuntu 20.04 LTS                        | 1.21, 1.22, 1.23, 1.24, 1.25 |                   | VMware vSphere 7.0 U3c, 8.0 | 1.21, 1.22, 1.23, 1.24, 1.25  |                                     |
    +-----------------------------------------+------------------------------+-------------------+-----------------------------+-------------------------------+-------------------------------------+
    ...
    +-----------------------------------------+------------------------------+-------------------+-----------------------------+-------------------------------+-------------------------------------+
    | Red Hat Enterprise Linux 8.4, 8.6, 8.7  | 1.21, 1.22, 1.23, 1.24, 1.25 |                   |                             | 1.21, 1.22, 1.23, 1.24, 1.25  |                                     |
    +-----------------------------------------+------------------------------+-------------------+-----------------------------+-------------------------------+-------------------------------------+
...
For more information on GPUDirect RDMA refer to :ref:`this document <operator-rdma-22.9.1>`.
