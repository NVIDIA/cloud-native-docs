...
.. _install-gpu-operator-22.9.1-proxy:
...
The instructions for Openshift are different, so skip the section titled :ref:`proxy_config_openshift-22.9.1` if you are not running Openshift.
...
.. _proxy_config_openshift-22.9.1:
