...
.. _gpu-operator-helm-chart-options-22.9.0:
...
.. note::
   ...
   * For installing on Secure Boot systems or using Precompiled modules refer to :ref:`install-precompiled-signed-drivers-22.9.0`.
...
.. note::
   ...
   Refer to the document :ref:`install-gpu-operator-22.9.0-vgpu` for detailed instructions on the workflow and required values of
...
Refer to :ref:`GPU Operator with NVIDIA AI Enterprise <install-gpu-operator-22.9.0-nvaie>`.
...
.. _preinstalled-drivers-and-toolkit-22.9.0:
...
.. _custom-runtime-options-22.9.0:
...
Refer to the section :ref:`install-gpu-operator-22.9.0-proxy` for more information on how to install the Operator on clusters
behind a HTTP proxy.
...
Refer to the section :ref:`install-gpu-operator-22.9.0-air-gapped` for more information on how to install the Operator
...
Refer to the document :ref:`install-gpu-operator-22.9.0-mig` for more information on how use the Operator with Multi-Instance GPU (MIG)
...
Refer to the document :ref:`gpu-operator-kubevirt-22.9.0` for more information on how to use the GPU Operator to provision GPU nodes for running KubeVirt virtual machines with access to GPU.
For guidance on using the GPU Operator with OpenShift Virtualization, refer to the document :ref:`nvidia-gpu-operator-openshift-virtualization-vgpu-enablement-22.9.0`.

Outdated Kernels
""""""""""""""""""""""""""

Refer to the section :ref:`install-gpu-operator-22.9.0-outdated-kernels` for more information on how to install the Operator successfully
