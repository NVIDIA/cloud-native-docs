...
#. You have followed the guidance in :ref:`NVIDIA documentation <steps-overview-22.9.0>` proceeding as far as creating the `cluster policy <create-cluster-policy-22.9.0>`.
...
#. Label the node with this newly created profile following the guidance in :ref:`MIG-partitioning-22.9.0`.
