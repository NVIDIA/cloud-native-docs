...
.. _gpu-operator-kubevirt-1.11.1:

Running KubeVirt VMs with the GPU Operator
******************************************

.. _gpu-operator-kubevirt-1.11.1-introduction:
...
.. _gpu-operator-kubevirt-1.11.1-limitations:
...
Optionally, label the worker node explicitly with a vGPU devices config. More information on vGPU devices config is detailed in :ref:`this section <apply-new-vgpu-device-config-1.11.1>` below.
...
.. _apply-new-vgpu-device-config-1.11.1:
