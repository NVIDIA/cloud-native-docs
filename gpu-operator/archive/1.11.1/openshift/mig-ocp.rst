...
#. You have followed the guidance in :ref:`NVIDIA documentation <steps-overview-1.11.1>` proceeding as far as creating the `cluster policy <create-cluster-policy-1.11.1>`.
...
#. Label the node with this newly created profile following the guidance in :ref:`MIG-partitioning-1.11.1`.
