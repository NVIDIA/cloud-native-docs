...
.. _operator-platform-support-1.11.1:
...
.. _operator-component-matrix-1.11.1:
...
.. tabs::
  ...
  .. tab:: Datacenter A-series Products
    ...
    .. note::
      ...
      The GPU Operator supports DGX A100 with DGX OS 5.1+ and Red Hat OpenShift using Red Hat Core OS. For installation instructions, see :ref:`here <preinstalled-drivers-and-toolkit-1.11.1>` for DGX OS 5.1+ and :ref:`here <openshift-introduction-1.11.1>` for Red Hat OpenShift.
...
For more information on GPUDirect RDMA refer to :ref:`this document <operator-rdma-1.11.1>`.
...
* :ref:`KubeVirt support with vGPU and GPU Passthrough <gpu-operator-kubevirt-1.11.1>`
