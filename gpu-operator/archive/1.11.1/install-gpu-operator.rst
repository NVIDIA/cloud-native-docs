...
.. _gpu-operator-helm-chart-options-1.11.1:
...
.. note::
   ...
   * For installing on Secure Boot systems or using Precompiled modules refer to :ref:`install-precompiled-signed-drivers-1.11.1`.
...
.. note::
   ...
   Refer to the document :ref:`install-gpu-operator-1.11.1-vgpu` for detailed instructions on the workflow and required values of
...
Refer to :ref:`GPU Operator with NVIDIA AI Enterprise <install-gpu-operator-1.11.1-nvaie>`.
...
.. _preinstalled-drivers-and-toolkit-1.11.1:
...
Refer to the section :ref:`install-gpu-operator-1.11.1-proxy` for more information on how to install the Operator on clusters
behind a HTTP proxy.
...
Refer to the section :ref:`install-gpu-operator-1.11.1-air-gapped` for more information on how to install the Operator
...
Refer to the document :ref:`install-gpu-operator-1.11.1-mig` for more information on how use the Operator with Multi-Instance GPU (MIG)
...
Refer to the section :ref:`install-gpu-operator-1.11.1-outdated-kernels` for more information on how to install the Operator successfully
