...
.. _install-gpu-operator-1.9.0-mig:
...
.. note::
   ...
   an additional option during installation ``--set driver.enabled=false``. See :ref:`mig-with-preinstalled-drivers-1.9.0`
   for more details.
...
.. _mig-with-preinstalled-drivers-1.9.0:
