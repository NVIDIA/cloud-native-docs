...
.. _operator-platform-support-1.9.0:
...
.. note::
   ...
   The GPU Operator supports DGX A100 with DGX OS 5.1+. Please see :ref:`preinstalled-drivers-and-toolkit-1.9.0` for further installation instructions.
...
.. _operator-component-matrix-1.9.0:
