...
.. note::
   ...
   Refer to the document :ref:`install-gpu-operator-1.9.0-vgpu` for detailed instructions on the workflow and required values of
...
.. note::
   ...
   prior to installation. Refer to the document :ref:`install-gpu-operator-1.9.0-nvaie` for instructions
...
.. _preinstalled-drivers-and-toolkit-1.9.0:
...
Refer to the section :ref:`install-gpu-operator-1.9.0-proxy` for more information on how to install the Operator on clusters
behind a HTTP proxy.
...
Refer to the section :ref:`install-gpu-operator-1.9.0-air-gapped` for more information on how to install the Operator
...
Refer to the document :ref:`install-gpu-operator-1.9.0-mig` for more information on how use the Operator with Multi-Instance GPU (MIG)
...
Refer to the section :ref:`install-gpu-operator-1.9.0-outdated-kernels` for more information on how to install the Operator successfully
