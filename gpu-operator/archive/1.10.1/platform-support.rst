...
.. _operator-platform-support-1.10.1:
...
.. note::
   ...
   see :ref:`here <preinstalled-drivers-and-toolkit-1.10.1>` for DGX OS 5.1+ and :ref:`here <openshift-introduction-1.10.1>` for OCP.
...
.. _operator-component-matrix-1.10.1:
...
For more information on GPUDirect RDMA refer to :ref:`this document <operator-rdma-1.10.1>`.
