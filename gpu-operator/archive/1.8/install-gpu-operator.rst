...
.. note::
   ...
   Refer to the document :ref:`install-gpu-operator-1.8-vgpu` for detailed instructions on the workflow and required values of
...
.. note::
   ...
   prior to installation. Refer to the document :ref:`install-gpu-operator-1.8-nvaie` for instructions
...
Refer to the section :ref:`install-gpu-operator-1.8-proxy` for more information on how to install the Operator on clusters
behind a HTTP proxy.
...
Refer to the section :ref:`install-gpu-operator-1.8-air-gapped` for more information on how to install the Operator
...
Refer to the document :ref:`install-gpu-operator-1.8-mig` for more information on how use the Operator with Multi-Instance GPU (MIG)
...
Refer to the section :ref:`install-gpu-operator-1.8-outdated-kernels` for more information on how to install the Operator successfully
