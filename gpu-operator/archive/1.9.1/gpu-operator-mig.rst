...
.. _install-gpu-operator-1.9.1-mig:
...
.. note::
   ...
   an additional option during installation ``--set driver.enabled=false``. See :ref:`mig-with-preinstalled-drivers-1.9.1`
   for more details.
...
.. _mig-with-preinstalled-drivers-1.9.1:
