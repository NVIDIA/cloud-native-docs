...
#. You have followed the guidance in `NVIDIA documentation <https://docs.nvidia.com/datacenter/cloud-native/openshift/steps-overview.html>`_ proceeding as far as creating the `cluster policy <https://docs.nvidia.com/datacenter/cloud-native/openshift/install-gpu-ocp.html#create-the-cluster-policy-for-the-nvidia-gpu-operator>`_.
