...
- A working OpenShift cluster up and running with a GPU worker node. Refer to the [OpenShift Container Platform installation overview](https://docs.redhat.com/en/documentation/openshift_container_platform/latest/html/installation_overview/ocp-installation-overview) for installation guidance.
