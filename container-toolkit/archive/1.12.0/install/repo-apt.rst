...
.. note::
   If running ``apt update`` after configuring repositories raises an error regarding a conflict in the Signed-By option, see the :ref:`relevant troubleshooting section<conflicting_signed_by-1.12.0>`.
